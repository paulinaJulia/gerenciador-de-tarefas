  ...
  <div class="itemTask">
    ...
    <button @click="$emit('click:concluir')" class="cursor-pointer">
      ...
      >
        <g opacity="0.9">
          <path
            d="M11.9801 19.4262C16.0726 19.4262 19.3903 16.1085 19.3903 12.0159C19.3903 7.92336 16.0726 4.60568 11.9801 4.60568C7.8875 4.60568 4.56982 7.92336 4.56982 12.0159C4.56982 16.1085 7.8875 19.4262 11.9801 19.4262Z"
            fill="#5E60CE"
          />
          <path
          ...
          />
          <path
            d="M15.4306 9.34212L11.0986 13.6741L8.61618 11.1916L7.78027 12.0275L11.0986 15.3459L16.2665 10.178L15.4306 9.34212Z"
            fill="#F2F2F2"
          />
        </g>
      </svg>
...
const openEditarTask = async (id) => {
  ...
  modalCriarTask.value.state.modo = 'editar'
  openModal()
}

const openvisualizarTask = async (id) => {
  await getTaskLocalStorage(id)
  console.log(taskActive.value, 'active')
